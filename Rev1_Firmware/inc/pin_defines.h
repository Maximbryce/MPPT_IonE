...
constexpr uint16_t BATTERY_CURRENT_ADC_PIN = GPIO_PIN_0;
static GPIO_TypeDef* const BATTERY_CURRENT_ADC_PORT = GPIOA;
...
constexpr uint16_t ARRAY_CURRENT_ADC_PIN = GPIO_PIN_14;
static GPIO_TypeDef* const ARRAY_CURRENT_ADC_PORT = GPIOB;

/* Pins for Temp sense channel */
static GPIO_TypeDef* const TEMP_ADC_PORT = GPIOE;
constexpr uint16_t TEMP_ADC_PIN = GPIO_PIN_10;

/* Pins for HAL reference voltages channels*/
static GPIO_TypeDef* const BAT_HAL_REF_PORT = GPIOE;
constexpr uint16_t BAT_HAL_REF_PIN = GPIO_PIN_8;
static GPIO_TypeDef* const ARRAY_HAL_REF_PORT = GPIOE;
constexpr uint16_t ARRAY_HAL_REF_PIN = GPIO_PIN_12;
